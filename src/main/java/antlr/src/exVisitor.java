...
public interface exVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link exParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassDecl(exParser.ClassDeclContext ctx);
	/**
	 * Visit a parse tree produced by {@link exParser#classBody}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassBody(exParser.ClassBodyContext ctx);
	/**
	 * Visit a parse tree produced by {@link exParser#classCtorDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassCtorDecl(exParser.ClassCtorDeclContext ctx);
	/**
	 * Visit a parse tree produced by {@link exParser#classCall}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassCall(exParser.ClassCallContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link exParser#statementExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStatementExpression(exParser.StatementExpressionContext ctx);
	/**
